...
pub fn jump26_reloc(
    ...
    let jump_offset64 = target.wrapping_sub(base).cast_signed();
...
pub fn tst_br14_reloc(
    ...
    let tst_offset64 = target.wrapping_sub(base).cast_signed();
...
pub fn cond_br19_reloc(
    ...
    let cond_offset64 = target.wrapping_sub(base).cast_signed();
