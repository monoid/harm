...
pub fn stp<TargetInp1, TargetInp2, TargetOut, AddrInp, AddrOut>(
    dst: (TargetInp1, TargetInp2),
    addr: AddrInp,
) -> <Stp<TargetOut, AddrOut> as MakeStp<TargetInp1, TargetInp2, AddrInp>>::Output
where
    Stp<TargetOut, AddrOut>: MakeStp<TargetInp1, TargetInp2, AddrInp>,
{
    Stp::new(dst, addr)
}
