...
pub fn ldpsw<TargetInp1, TargetInp2, TargetOut, AddrInp, AddrOut>(
    dst: (TargetInp1, TargetInp2),
    addr: AddrInp,
) -> <Ldpsw<TargetOut, AddrOut> as MakeLdpsw<TargetInp1, TargetInp2, AddrInp>>::Output
where
    Ldpsw<TargetOut, AddrOut>: MakeLdpsw<TargetInp1, TargetInp2, AddrInp>,
{
    Ldpsw::new(dst, addr)
}
