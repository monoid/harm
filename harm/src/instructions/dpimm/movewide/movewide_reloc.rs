...
mod tests {
    ...
    fn test_64_abs_g0_movz() {
        ...
        assert_eq!(inst.1, Some(Rel64::movw_uabs_g0(label)));
    }
    ...
    fn test_64_abs_g1_movk() {
        ...
        assert_eq!(inst.1, Some(Rel64::movw_uabs_g1(label)));
    }
    ...
    fn test_64_abs_g1s_movn() {
        ...
        assert_eq!(inst.1, Some(Rel64::movw_sabs_g1(label)));
    }
    ...
    fn test_64_abs_g1nc_movk() {
        ...
        assert_eq!(inst.1, Some(Rel64::movw_uabs_g1_nc(label)));
    }
    ...
    fn test_64_abs_g2_movz() {
        ...
        assert_eq!(inst.1, Some(Rel64::movw_uabs_g2(label)));
    }
    ...
    fn test_64_abs_g2s_movz() {
        ...
        assert_eq!(inst.1, Some(Rel64::movw_sabs_g2(label)));
    }
    ...
    fn test_64_abs_g2nc_movk() {
        ...
        assert_eq!(inst.1, Some(Rel64::movw_uabs_g2_nc(label)));
    }
    ...
    fn test_64_abs_g3_movk() {
        ...
        assert_eq!(inst.1, Some(Rel64::movw_uabs_g3(label)));
    }
