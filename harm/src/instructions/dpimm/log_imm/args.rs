...
impl<RdIn, RnIn> MakeSpLogicalArgs<RdIn, RnIn, u32> for LogicalArgs<RegOrSp32, RegOrZero32, LogicalImmFields>
where
    RdIn: IntoReg<RegOrSp32>,
    RnIn: IntoReg<RegOrZero32>,
{
...
impl<RdIn, RnIn> MakeSpLogicalArgs<RdIn, RnIn, u64> for LogicalArgs<RegOrSp64, RegOrZero64, LogicalImmFields>
where
    RdIn: IntoReg<RegOrSp64>,
    RnIn: IntoReg<RegOrZero64>,
{
...
impl<RdIn, RnIn> MakeZeroLogicalArgs<RdIn, RnIn, u32> for LogicalArgs<RegOrZero32, RegOrZero32, LogicalImmFields>
where
    RdIn: IntoReg<RegOrZero32>,
    RnIn: IntoReg<RegOrZero32>,
{
...
impl<RdIn, RnIn> MakeZeroLogicalArgs<RdIn, RnIn, u64> for LogicalArgs<RegOrZero64, RegOrZero64, LogicalImmFields>
where
    RdIn: IntoReg<RegOrZero64>,
    RnIn: IntoReg<RegOrZero64>,
{
