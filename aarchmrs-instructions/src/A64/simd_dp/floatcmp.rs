...
pub mod FCMP_SZ_floatcmp {
    ...
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110001000000010000000001000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn FCMP_SZ_floatcmp(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0001111000100000001000u32 << 10u32 | Rn.into_inner() << 5u32 | 0b01000u32 << 0u32,
        )
    }
}
pub mod FCMPE_S_floatcmp {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111000001111110000011111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110001000000010000000010000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
...
pub mod FCMPE_SZ_floatcmp {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111111110000011111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110001000000010000000011000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000111110000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn FCMPE_SZ_floatcmp(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0001111000100000001000u32 << 10u32 | Rn.into_inner() << 5u32 | 0b11000u32 << 0u32,
        )
    }
}
...
pub mod FCMP_DZ_floatcmp {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111111110000011111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110011000000010000000001000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000111110000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn FCMP_DZ_floatcmp(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0001111001100000001000u32 << 10u32 | Rn.into_inner() << 5u32 | 0b01000u32 << 0u32,
        )
    }
}
pub mod FCMPE_D_floatcmp {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111000001111110000011111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110011000000010000000010000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
...
pub mod FCMPE_DZ_floatcmp {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111111110000011111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110011000000010000000011000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000111110000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn FCMPE_DZ_floatcmp(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0001111001100000001000u32 << 10u32 | Rn.into_inner() << 5u32 | 0b11000u32 << 0u32,
        )
    }
}
...
pub mod FCMP_HZ_floatcmp {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111111110000011111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110111000000010000000001000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000111110000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn FCMP_HZ_floatcmp(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0001111011100000001000u32 << 10u32 | Rn.into_inner() << 5u32 | 0b01000u32 << 0u32,
        )
    }
}
pub mod FCMPE_H_floatcmp {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111000001111110000011111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110111000000010000000010000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
...
pub mod FCMPE_HZ_floatcmp {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111111110000011111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b00011110111000000010000000011000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000111110000000000000000u32;
    #[cfg(feature = "meta")]
