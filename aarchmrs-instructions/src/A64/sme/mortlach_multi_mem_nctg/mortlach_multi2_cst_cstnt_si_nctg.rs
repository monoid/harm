...
pub mod stnt1b_mzx_p_bi_2x8 {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct stnt1b_mzx_p_bi_2x8 {
        pub imm4: ::aarchmrs_types::BitValue<4>,
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub PNg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod stnt1h_mzx_p_bi_2x8 {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct stnt1h_mzx_p_bi_2x8 {
        pub imm4: ::aarchmrs_types::BitValue<4>,
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub PNg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod stnt1w_mzx_p_bi_2x8 {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct stnt1w_mzx_p_bi_2x8 {
        pub imm4: ::aarchmrs_types::BitValue<4>,
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub PNg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod stnt1d_mzx_p_bi_2x8 {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct stnt1d_mzx_p_bi_2x8 {
        pub imm4: ::aarchmrs_types::BitValue<4>,
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub PNg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
