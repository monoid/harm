...
pub mod usdot_za_zzw_s4x4 {
    pub const OPCODE_MASK: u32 = 0b11111111111000111001110001111000u32;
    pub const OPCODE: u32 = 0b11000001101000010001010000001000u32;
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    pub const NAME: &str = "usdot_za_zzw_s4x4";
    #[derive(Copy, Clone, Debug, Default)]
    pub struct usdot_za_zzw_s4x4 {
        pub Zm: ::aarchmrs_types::BitValue<3>,
        pub Rv: ::aarchmrs_types::BitValue<2>,
        pub Zn: ::aarchmrs_types::BitValue<3>,
        pub off3: ::aarchmrs_types::BitValue<3>,
    }
    impl usdot_za_zzw_s4x4 {
        #[inline]
        pub const fn new(
