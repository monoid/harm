...
pub mod fmopa_za16_pp_z8z8_8 {
    ...
    pub const OPCODE: u32 = 0b10000000101000000000000000001000u32;
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    pub const NAME: &str = "fmopa_za16_pp_z8z8_8";
    #[derive(Copy, Clone, Debug, Default)]
    pub struct fmopa_za16_pp_z8z8_8 {
