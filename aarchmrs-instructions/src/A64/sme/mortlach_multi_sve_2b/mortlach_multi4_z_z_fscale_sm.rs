...
pub mod fscale_mz_zzv_4x1 {
    ...
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b11000001001000001010100110000000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    pub const NAME: &str = "fscale_mz_zzv_4x1";
    ...
    #[inline]
    pub const fn fscale_mz_zzv_4x1(
...
pub mod bfscale_mz_zzv_4x1 {
    ...
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    pub const NAME: &str = "bfscale_mz_zzv_4x1";
    #[cfg(feature = "meta_field")]
    #[allow(nonstandard_style)]
    pub const FIELD_Zdn_OFFSET: u32 = 2u32;
    #[cfg(feature = "meta_field")]
    ...
    pub const FIELD_Zm_WIDTH: u32 = 4u32;
    #[inline]
    pub const fn bfscale_mz_zzv_4x1(
        Zm: ::aarchmrs_types::BitValue<4>,
        Zdn: ::aarchmrs_types::BitValue<3>,
    ) -> ::aarchmrs_types::InstructionCode {
        ::aarchmrs_types::InstructionCode::from_u32(
