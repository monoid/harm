...
pub mod st2b_z_p_br_contiguous {
    ...
    pub struct st2b_z_p_br_contiguous {
...
pub mod st3b_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st3b_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st4b_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st4b_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st2h_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st2h_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st3h_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st3h_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st4h_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st4h_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st2w_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st2w_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st3w_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st3w_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st4w_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st4w_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st2d_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st2d_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st3d_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st3d_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
...
pub mod st4d_z_p_br_contiguous {
    #[derive(Copy, Clone, Debug, Default)]
    pub struct st4d_z_p_br_contiguous {
        pub msz: ::aarchmrs_types::BitValue<2>,
        pub Rm: ::aarchmrs_types::BitValue<5>,
        pub Pg: ::aarchmrs_types::BitValue<3>,
        pub Rn: ::aarchmrs_types::BitValue<5>,
