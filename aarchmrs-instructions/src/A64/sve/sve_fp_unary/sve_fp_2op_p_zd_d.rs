...
pub mod flogb_z_p_z_m {
    ...
    #[cfg(feature = "meta_field")]
    #[allow(nonstandard_style)]
    pub const FIELD_size_OFFSET: u32 = 17u32;
    #[cfg(feature = "meta_field")]
    #[allow(nonstandard_style)]
...
pub mod fcvtzs_z_p_z_s2w {
    ...
    pub const fn fcvtzs_z_p_z_s2w(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010110011100101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzs_z_p_z_d2w {
    ...
    pub const fn fcvtzs_z_p_z_d2w(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010111011000101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzs_z_p_z_s2x {
    ...
    pub const fn fcvtzs_z_p_z_s2x(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010111011100101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzs_z_p_z_d2x {
    ...
    pub const fn fcvtzs_z_p_z_d2x(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010111011110101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzs_z_p_z_fp162h {
    ...
    pub const fn fcvtzs_z_p_z_fp162h(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010101011010101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzs_z_p_z_fp162w {
    ...
    pub const fn fcvtzs_z_p_z_fp162w(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010101011100101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzs_z_p_z_fp162x {
    ...
    pub const fn fcvtzs_z_p_z_fp162x(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010101011110101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzu_z_p_z_s2w {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111110000000000000u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b01100101100111011010000000000000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn fcvtzu_z_p_z_s2w(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010110011101101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzu_z_p_z_d2w {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111110000000000000u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b01100101110110011010000000000000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn fcvtzu_z_p_z_d2w(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010111011001101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzu_z_p_z_s2x {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111110000000000000u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b01100101110111011010000000000000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn fcvtzu_z_p_z_s2x(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010111011101101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzu_z_p_z_d2x {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111110000000000000u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b01100101110111111010000000000000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn fcvtzu_z_p_z_d2x(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010111011111101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzu_z_p_z_fp162h {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111110000000000000u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b01100101010110111010000000000000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn fcvtzu_z_p_z_fp162h(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010101011011101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzu_z_p_z_fp162w {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111110000000000000u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b01100101010111011010000000000000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn fcvtzu_z_p_z_fp162w(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010101011101101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
...
pub mod fcvtzu_z_p_z_fp162x {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111111111110000000000000u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b01100101010111111010000000000000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000000000000u32;
    #[cfg(feature = "meta")]
    ...
    pub const fn fcvtzu_z_p_z_fp162x(
        ...
        ::aarchmrs_types::InstructionCode::from_u32(
            0b0110010101011111101u32 << 13u32
                | Pg.into_inner() << 10u32
                | Zn.into_inner() << 5u32
                | Zd.into_inner() << 0u32,
        )
