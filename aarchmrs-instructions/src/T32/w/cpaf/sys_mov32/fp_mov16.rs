...
pub mod VMOV_toh_T1 {
    ...
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b11101110000000000000100100010000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000001101111u32;
    #[cfg(feature = "meta")]
    pub const NAME: &str = "VMOV_toh_T1";
...
pub mod VMOV_h_T1 {
    ...
    pub const OPCODE_MASK: u32 = 0b11111111111100000000111101111111u32;
    #[cfg(feature = "meta")]
    pub const OPCODE: u32 = 0b11101110000100000000100100010000u32;
    #[cfg(feature = "meta")]
    pub const SHOULD_BE_MASK: u32 = 0b00000000000000000000000001101111u32;
    #[cfg(feature = "meta")]
    pub const NAME: &str = "VMOV_h_T1";
    #[cfg(feature = "meta_field")]
    #[allow(nonstandard_style)]
    pub const FIELD_N_OFFSET: u32 = 7u32;
    #[cfg(feature = "meta_field")]
